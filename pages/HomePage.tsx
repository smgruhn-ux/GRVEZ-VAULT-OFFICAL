...
export function HomePage() {
  return (
    <>
      <section className="home-hero-v2"><div className="home-hero-v2-bg"><ApprovedImage src="/GRVEZ_VAULT_Home_Hero.png" fallback="/home-hero.png" alt="" loading="eager" /></div><div className="home-hero-v2-grain" aria-hidden="true" /><div className="home-hero-v2-content"><p className="home-hero-v2-eyebrow">Music · Archive · Research · Film</p><h1 className="home-hero-headline">AS ABOVE<br />SO BELOW</h1><p className="home-hero-v2-desc">The day it was created. And the day someone finally understands why it mattered. GRVEZ VAULT preserves music, writing, film, and research exactly as they were originally created.</p><a href="#pathways" className="home-hero-v2-cta">Enter the Vault →</a></div></section>
      <section className="pathways-grid" id="pathways">
        ...
        <Link to="/relational-continuity" className="pathway-panel"><div className="pathway-panel-bg"><ApprovedImage src="/GRVEZ_VAULT_Relational_Continuity_Pathway.png" fallback="/founding-edition.jpeg" alt="" /></div><div className="pathway-panel-content"><h2>Relational<br />Continuity</h2><p className="pathway-tagline">Patterns persist</p><span className="pathway-action">Explore Research →</span></div></Link>
      ...
      <section className="home-row"><div className="home-row-header"><div><h2 className="home-row-title">Archive Highlights</h2></div><Link to="/archive" className="home-row-link">View All Archive →</Link></div><div className="home-row-items"><Link to="/record/001" className="home-row-item"><div className="home-row-item-img"><img src="/FOREVERMORE POEM COVER PHOTO.png" alt="Forevermore poem cover" loading="lazy" /></div><p className="home-row-item-title">Forevermore</p><p className="home-row-item-type">Recovered Poem</p></Link><Link to="/record/004" className="home-row-item"><div className="home-row-item-img"><img src="/EMBERS POEM COVER PHOTO.png" alt="Embers poem cover" loading="lazy" /></div><p className="home-row-item-title">Embers</p><p className="home-row-item-type">Recovered Poem</p></Link><Link to="/record/008" className="home-row-item"><div className="home-row-item-img"><img src="/founding-edition.jpeg" alt="Founding Edition" loading="lazy" /></div><p className="home-row-item-title">Founding Edition</p><p className="home-row-item-type">Manuscript</p></Link></div></section>
    </>
  );
}
