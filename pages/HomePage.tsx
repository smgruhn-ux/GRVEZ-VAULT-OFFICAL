...
export function HomePage() {
  return (
    <>
      <section className="home-hero-v2"><div className="home-hero-v2-bg"><ApprovedImage src="/GRVEZ_VAULT_Home_Hero.png" fallback="/home-hero.png" alt="" loading="eager" /></div><div className="home-hero-v2-grain" aria-hidden="true" /><div className="home-hero-v2-content"><p className="home-hero-v2-eyebrow">Music · Archive · Research · Film</p><h1 className="home-hero-headline">AS ABOVE, SO BELOW</h1><p className="home-hero-v2-desc">The day it was created. And the day someone finally understands why it mattered. GRVEZ VAULT preserves music, writing, film, and research exactly as they were originally created.</p><a href="#pathways" className="home-hero-v2-cta">Enter the Vault →</a></div></section>
