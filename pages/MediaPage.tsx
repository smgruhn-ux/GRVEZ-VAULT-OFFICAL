...
const records = [
  ...
  { id: "007", type: "RECURRING VISUAL / SYMBOLIC MOTIF", title: "Raven Motif", preview: "A source-grounded record of recurring raven imagery and its later evolution toward winged self-representation.", source: "Cross Reference and surviving file records", status: "PRE-FRAMEWORK MOTIF WITH LATER EVOLUTION", route: "/media/raven-motif", image: "/JESTER GIZZY W. RAVEN.JPG" },
];
