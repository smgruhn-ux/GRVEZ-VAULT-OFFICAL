...
const details: Record<string, { title: string; date: string; source: string; provenance: string; image: string; card: string; notes: string }> = {
  ...
  "hourglass-tattoo": { title: "Hourglass Tattoo", date: "March 25, 2019", source: "Primary source, Facebook screenshot", provenance: "Completed tattoo documented on the back of the neck.", image: "https://u234214232.p.clickup-attachments.com/u234214232/56ad0121-c4ef-47f5-a584-79d42d7080e1/hourglass_2019.png?view=open", card: "Visual 003", notes: "The supplied image documents a completed tattoo, not an original sketch." },
