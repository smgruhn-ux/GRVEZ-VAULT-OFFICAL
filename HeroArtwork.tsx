...
export function HeroArtwork({ image, alt, hotspots = [], loading = 'lazy', clean = false }: HeroArtworkProps) {
  ...
  return (
    <div className={`hero-frame${clean ? ' hero-frame-clean' : ''}`} ref={frameRef}>
      {!clean ? <div className="hero-backdrop-wrap" aria-hidden="true">
      ...
      />
      {!clean ? <div className="hero-grain" aria-hidden="true" /> : null}
      {!clean ? <svg className="hero-fracture" aria-hidden="true" viewBox="0 0 200 400" preserveAspectRatio="none">
