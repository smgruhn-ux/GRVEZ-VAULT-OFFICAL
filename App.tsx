...
import { RavenMotifPage } from './pages/RavenMotifPage';
import { BlackMawPage } from './pages/BlackMawPage';
import { NotFoundPage } from './pages/NotFoundPage';

export function App() {
  return (<BrowserRouter><Layout><Routes>
    <Route path="/" element={<HomePage />} /><Route path="/about" element={<AboutPage />} /><Route path="/about/gizzy-graves" element={<GizzyGravesPage />} /><Route path="/about/dmonix" element={<DmonixPage />} /><Route path="/dxxd-grvez" element={<DxxdGrvezPage />} /><Route path="/music" element={<MusicPage />} /><Route path="/archive" element={<ArchivePage />} /><Route path="/manuscripts" element={<ManuscriptsPage />} /><Route path="/relational-continuity" element={<RelationalContinuityPage />} /><Route path="/films" element={<FilmsPage />} /><Route path="/films/questions/:question" element={<DocumentaryQuestionPage />} /><Route path="/record/:id" element={<RecordPage />} /><Route path="/media" element={<MediaPage />} /><Route path="/media/raven-motif" element={<RavenMotifPage />} /><Route path="/media/black-maw" element={<BlackMawPage />} /><Route path="/media/:slug" element={<VisualDetailPage />} /><Route path="/vaultline" element={<VaultlinePage />} /><Route path="/contact" element={<ContactPage />} /><Route path="/privacy-policy" element={<PrivacyPolicyPage />} /><Route path="/terms-of-use" element={<TermsOfUsePage />} /><Route path="/faq" element={<FaqPage />} /><Route path="*" element={<NotFoundPage />} />
